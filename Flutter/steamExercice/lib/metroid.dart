...
class MyMetroidvania extends StatefulWidget {
  List<Game> gameList = [];
  MyMetroidvania(this.gameList, {super.key});

  @override
  State<MyMetroidvania> createState() => _MyMetroidvaniaState();
}

class _MyMetroidvaniaState extends State<MyMetroidvania> {
  bool csotnControl = false, hkControl = false, bpControl = false;
  
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Metroidvania", style: TextStyle(color: Colors.white)), centerTitle: true, backgroundColor: Colors.black),
      body: SingleChildScrollView(child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(child: Image.asset("images/castlevaniaSOTN.png"), height: 200),
              SizedBox(height: 5),
              SizedBox(
              ...
              SizedBox(child: Image.asset("images/hollowKnight.png"), height: 200), 
              SizedBox(
                child: CheckboxListTile(
              ...
              SizedBox(child: Image.asset("images/blasphemous.png"), height: 200),
              SizedBox(
                child: CheckboxListTile(
