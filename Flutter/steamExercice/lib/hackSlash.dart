...
class MyHackAndSlash extends StatefulWidget {
  List<Game> gameList = [];
  MyHackAndSlash(this.gameList, {super.key});

  @override
  State<MyHackAndSlash> createState() => _MyHackAndSlashState();
}

class _MyHackAndSlashState extends State<MyHackAndSlash> {
  bool csotnControl = false, hkControl = false, bpControl = false;
  
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Hack and Slash", style: TextStyle(color: Colors.white)), centerTitle: true, backgroundColor: Colors.black),
      body: SingleChildScrollView(child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(child: Image.asset("images/castlevaniaLOS2.png"), height: 200),
              SizedBox(height: 5),
              SizedBox(
              ...
              SizedBox(child: Image.asset("images/gow3.png"), height: 200), 
              SizedBox(
                child: CheckboxListTile(
              ...
              SizedBox(child: Image.asset("images/devilMayCry5.png"), height: 200),
              SizedBox(
                child: CheckboxListTile(
